...
public class Violence extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //pergunta1
        Cursor c=aj.devolvePergunta(1,2);
        c.moveToFirst();
        String str=c.getString(0);
        tv1.setText(str);

        //pergunta2
        c=aj.devolvePergunta(2,2);
        c.moveToFirst();
        str=c.getString(0);
        tv2.setText(str);

        //pergunta3
        c=aj.devolvePergunta(3,2);
        c.moveToFirst();
        str=c.getString(0);
        tv3.setText(str);

        //pergunta4
        c=aj.devolvePergunta(4,2);
        c.moveToFirst();
        str=c.getString(0);
        tv4.setText(str);

        Cursor c1 = aj.devolveMedia(2);
    ...
    public void submit(View v) {
        ...
        if ((radioButton111.isChecked() | radioButton112.isChecked() | radioButton113.isChecked() || radioButton114.isChecked() | radioButton115.isChecked() | radioButton116.isChecked() | radioButton117.isChecked()) &&
            ...
            aj.addTema((new Resposta(2,df.format(rf))));
