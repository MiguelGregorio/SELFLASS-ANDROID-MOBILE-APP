...
public class Sense extends AppCompatActivity {
    ...
    RadioGroup rg11,rg12,rg13,rg14, rg15;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //pergunta1
        Cursor c = aj.devolvePergunta(1, 3);
        c.moveToFirst();
        String str = c.getString(0);
        tv1.setText(str);

        //pergunta2
        c = aj.devolvePergunta(2, 3);
        c.moveToFirst();
        str = c.getString(0);
        tv2.setText(str);

        //pergunta3
        c = aj.devolvePergunta(3, 3);
        c.moveToFirst();
        str = c.getString(0);
        tv3.setText(str);

        //pergunta4
        c = aj.devolvePergunta(4, 3);
        c.moveToFirst();
        str = c.getString(0);
        tv4.setText(str);

        //pergunta5
        c = aj.devolvePergunta(5, 3);
        c.moveToFirst();
        str = c.getString(0);
        tv5.setText(str);

        Cursor c1 = aj.devolveMedia(3);
    ...
    public void submit(View v) {
        ...
        if ((radioButton111.isChecked() | radioButton112.isChecked() | radioButton113.isChecked() || radioButton114.isChecked() | radioButton115.isChecked() | radioButton116.isChecked() | radioButton117.isChecked()) &&
            ...
            rf =((float)(r1+r2+r3+r4+r5)/5);
            DecimalFormat df = new DecimalFormat("0.00");

            tvmedia.setText(df.format(rf));

            aj.addTema((new Resposta(3,df.format(rf))));
